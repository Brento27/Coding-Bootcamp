...
FROM 'C:\Users\Brent\OneDrive\Programming\SQL-Module\Analysis\us_counties_2000.csv'
...
FROM 'C:\Users\Brent\OneDrive\Programming\SQL-Module\Analysis\city_of_new_york.csv'
WITH (FORMAT CSV, HEADER);
...
FROM 'C:\Users\Brent\OneDrive\Programming\SQL-Module\Analysis\MPI_Directory_by_Establishment_Name.csv'
WITH (FORMAT CSV, HEADER, DELIMITER ',');
...
COPY state_regions
FROM 'C:\Users\Brent\OneDrive\Programming\SQL-Module\Analysis\state_regions.csv'
WITH (FORMAT CSV, HEADER, DELIMITER ',');
...
WHERE meat_poultry_egg_inspect.activities ILIKE ('%Meat Processing%');

UPDATE meat_poultry_egg_inspect
SET poultry_processing = TRUE
WHERE meat_poultry_egg_inspect.activities ILIKE ('%Poultry Processing%');

SELECT 	COUNT(meat_processing) AS meat_processing,
		COUNT(poultry_processing) AS poultry_processing
FROM meat_poultry_egg_inspect
WHERE meat_processing ILIKE ('true') OR poultry_processing = 'TRUE';

Select Count(activities) As meat_processing_and_poultry_processing
FROM meat_poultry_egg_inspect
WHERE meat_processing = 'TRUE' AND meat_processing = 'TRUE';
